    ...
    <?php
      foreach($records as $roll => $data) {
        echo '<div class="student-record">
          ...
          <span class="present">'."1".'</span>'.
          ' <button class="marker btn">P</button> <button class="btn btn-danger delete-roll" data-toggle="modal" data-target=".delete-warning">&times;</button>
        </div>';
      }      
    ?>
    </div>
